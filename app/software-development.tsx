...
const modules = [
  {
    ...
    description: 'Core JavaScript/TypeScript concepts, data structures, and problem-solving.',
    icon: 'code',
  },
  {
    title: 'Module 2: Frontend Development',
    description: 'Build responsive web apps with React, state management, and UI systems.',
    icon: 'web',
  },
  {
    title: 'Module 3: Backend Development',
    description: 'APIs, databases, authentication, and scalable service architecture.',
    icon: 'dns',
  },
  {
    title: 'Module 4: Mobile & Deployment',
    description: 'Ship apps with React Native, CI/CD, and production readiness.',
    icon: 'phone-iphone',
  },
];
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Software Development</Text>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          <View style={styles.hero}>
            ...
            <Text style={styles.subtitle}>Build web and mobile apps that scale globally.</Text>
          </View>
          ...
          <View style={styles.noticeCard}>
            ...
            <View style={styles.noticeContent}>
              ...
              <Text style={styles.noticeSubtitle}>Meet the instructors and get the learning roadmap.</Text>
            </View>
          </View>
